                ...
                <div class="row">
                    <div class="col-sm-6">
                        <div class="btn-group-vertical" style="margin-right: 1.5rem;">
                            ...
                            id="pukulan_m" atlitId="" tombol="puk_jm<?php echo e($kode); ?>" >
                                Pukulan(1)
                            </button>
                            <button class="button btn btn-flat btn-danger btn-lg"
                            id="tendangan_m" atlitId="" tombol="ten_jm<?php echo e($kode); ?>"
                    ...
                    <div class="col-sm-6 text-right">
                        ...
                        <div class="btn-group-vertical" style="margin-left: 1.5rem;">
                            ...
                            id="pukulan_b" atlitId="" tombol="puk_jb<?php echo e($kode); ?>">
                                Pukulan(1)
                            </button>
                            <button class="button btn btn-flat btn-primary btn-lg"
                            id="tendangan_b" atlitId="" tombol="ten_jb<?php echo e($kode); ?>"
                            style="margin-top: 1.5rem;">
                                Tendangan(2)
                            </button>
                        </div>
...
<?php echo $__env->make('layouts.themplate', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/mac/www/penjurian/application/views/contents/nilai-juri/penilaian.blade.php ENDPATH**/ ?>