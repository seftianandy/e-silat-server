						...
						<div class="container">
								...
								<div class="collapse navbar-collapse pull-left" id="navbar-collapse">
										<ul class="nav navbar-nav">
												<li>
													<a href="<?php echo e(base_url()); ?>index">
															Beranda
												...
												<li>
													<a href="<?php echo e(base_url()); ?>master-nilai/index">Master Nilai</a>
												</li>
												<li>
													<a href="<?php echo e(base_url()); ?>peserta/index">Peserta</a>
												</li>
												<li>
													<a href="<?php echo e(base_url()); ?>arena/index">Arena</a>
												</li>
												<li>
													<a href="<?php echo e(base_url()); ?>pertandingan/index">Pertandingan</a>
												</li>
												<?php 
													// } 
												?>
												...
												?>
												<li>
													<a href="<?php echo e(base_url()); ?>nilai-juri/index">Nilai Juri</a>
												</li>
												<?php 
													// } 
												?>
												...
												?>
												<li>
													<a href="<?php echo e(base_url()); ?>nilai-dewan/index">Set Timer</a>
												</li>
												<li>
													<a href="<?php echo e(base_url()); ?>nilai-dewan/index">Nilai Dewan Juri</a>
												</li>
												<?php 
													// } 
												?>
										...
										<ul class="nav navbar-nav">
												<li class="dropdown user user-menu">
														...
														<a href="#" class="dropdown-toggle" data-toggle="dropdown">
																...
																<img src="<?php echo e(base_url()); ?>dist/img/avatar5.png" class="user-image" alt="User Image">

																<span class="hidden-xs"><?php echo e($_SESSION['nama_user']); ?></span>
														</a>
...
<?php /**PATH C:\laragon\www\penjurian\application\views/layouts/themplate.blade.php ENDPATH**/ ?>